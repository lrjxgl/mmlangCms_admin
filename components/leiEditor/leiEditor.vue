<template>
	<view class="container" style="border: 1px solid #eee;">
		<view class="page-body">
			<view class='wrapper'>
				<view class='toolbar' @tap="format" style="height: 36px;overflow-y: auto;">
...
<script>
	export default {
		...
		created:function(){
			this.content=this.dcontent;
			 
		},
		watch:{
			dcontent:function(n,o){
				this.content=n
			}
		},
		methods: {
